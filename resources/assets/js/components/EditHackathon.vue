<template>
    <div class="card">
        ...
        <div class="card-footer text-right">
            <button type="submit" class="btn btn-primary" v-on:click="updateItem">Update Hackathon</button>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            updateItem: function() {
                ...
                axios.patch('/api/hackathons/' + self.item.id, this.item)
                    .then(function (response) {
                        swal('Yay...', 'Your hackathon is successfully updated.', 'success');
                        setTimeout(function() {
